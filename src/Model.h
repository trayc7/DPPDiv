...
class Model {
	...
	public:
                                        ...
                                        Model(MbRandom *rp, std::string clfn, std::string intfn, int nodpr, double rh, bool rnp, int bdp, bool fixFRG, int expMode); // model overload constructor for fofbd skyline
										~Model(void);
