...
class Model {
	...
	public:
                                        ...
                                        Model(MbRandom *rp, std::string clfn, int nodpr, double rh, bool rnp, int bdp, bool fixFRG, int fxSt, int fxSp, bool lSf, bool fxPsi, double psi); // model overload constructor for fofbd
										~Model(void);
