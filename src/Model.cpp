...
Model::Model(MbRandom *rp, std::string clfn, std::string intfn, std::string pafn, int nodpr, double rh, bool rnp, int bdp, bool fixFRG, bool estExt, int expMode, int fbdLk,
             int specPr, int psiPr, double bPrRate, double dPrRate, double pPrRate, bool proxy, bool fixPsi, bool ages){
    ...
    FossilRangeGraphSkyline *frg = new FossilRangeGraphSkyline(ranPtr, this, numFossils, numLineages, calibrs, userSpecifiedIntervals, intervals, runUnderPrior, fixFRG, estExt, expMode, fbdLk, ages);
