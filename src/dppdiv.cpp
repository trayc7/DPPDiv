...
void printHelp(bool files) 
{
	if(files){
        ...
        cout << " If -fbdrlk = 3 or 2 fossil counts\nare ignored\n";
        cout << "-----------------------------------------------\n";
        cout << "2\n";
        cout << "12.3\t5.1\t10\n";
        cout << "5.1\t0\t2\n";
        cout << "-----------------------------------------------\n\n";
        cout << "Presence absence file \n";
        cout << "Line 1 = number of ranges and intervals\n";
        cout << "From youngest to oldest (left to right) presence\n(=1) / absence (=0) data for each range. Order\nof ranges must correspond to the range file\n";
        cout << "-----------------------------------------------\n";
        cout << "5\t2\n";
        cout << "0\t0\n";
        cout << "0\t0\n";
